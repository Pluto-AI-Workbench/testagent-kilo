...
export const dict = {
  ...
  "command.session.redo.description": "恢复上一則復原的訊息",
  ...
  "settings.providers.tag.customProvider": "自訂模型API",
  "settings.providers.connected.environmentDescription": "從您的環境變數連線",
  "settings.providers.custom.description": "透過基礎 URL 新增 OpenAI 相容的模型API。",
  ...
  "provider.custom.title": "自訂模型API",
  "provider.custom.description.prefix": "設定 OpenAI 相容的模型API。請參閱",
  "provider.custom.description.link": "模型API設定文件",
  ...
  "provider.custom.error.providerID.required": "模型API ID 為必填",
  "provider.custom.error.providerID.format": "請使用小寫字母、數字、連字號或底線",
  "provider.custom.error.providerID.exists": "該模型API ID 已存在",
