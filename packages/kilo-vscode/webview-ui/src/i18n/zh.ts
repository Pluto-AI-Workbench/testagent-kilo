...
export const dict = {
  ...
  "command.category.provider": "模型API",
  ...
  "command.provider.connect": "连接模型API",
  ...
  "command.session.redo": "恢复",
  "command.session.redo.description": "恢复上一条撤销的消息",
  "revert.banner.count_one": "已还原 {{count}} 条消息",
  "revert.banner.count_other": "已还原 {{count}} 条消息",
  "revert.banner.redo": "撤销还原",
  "revert.banner.redo.all": "全部撤销",
  "revert.banner.hint": "发送新消息以使此更改永久生效",
  "revert.disabled.agentBusy": "等待智能体完成",
  "command.session.compact": "压缩上下文",
  ...
  "dialog.provider.search.placeholder": "搜索模型API",
  "dialog.provider.empty": "未找到模型API",
  ...
  "dialog.model.unpaid.addMore.title": "从热门模型API添加更多模型",

  "dialog.provider.viewAll": "查看更多模型API",
  ...
  "dialog.plugins.empty": "在 testagent.json 中配置的插件",
  ...
  "toast.model.none.description": "请先连接模型API以总结此会话",
  ...
  "error.chain.checkConfig": "请检查你的配置 (testagent.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: TestAgent 暂不支持 MCP 认证。',
  "error.chain.providerAuthFailed": "模型API认证失败（{{provider}}）：{{message}}",
  "error.chain.providerInitFailed": '无法初始化模型API "{{provider}}"。请检查凭据和配置。',
  ...
  "sidebar.gettingStarted.line2": "连接任意模型API即可使用更多模型，如 Claude、GPT、Gemini 等。",
  ...
  "settings.providers.title": "模型API",
  "settings.providers.description": "模型API设置将在此处可配置。",
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 TestAgent Gateway 模型API。在 Beta 测试期间即将支持配置其他模型API。在此期间，您可以使用 CLI 或配置文件来配置模型API。我们致力于保持 TestAgent 开放，无锁定。",
  "settings.providers.section.connected": "已连接的模型API",
  "settings.providers.connected.empty": "没有已连接的模型API",
  "settings.providers.section.popular": "热门模型API",
  "settings.providers.search.placeholder": "搜索模型API",
  "settings.providers.select.placeholder": "选择模型API...",
  ...
  "settings.providers.tag.customProvider": "自定义模型API",
  "settings.providers.connected.environmentDescription": "从您的环境变量连接",
  "settings.providers.custom.description": "通过基础 URL 添加 OpenAI 兼容的模型API。",
  "settings.providers.modeModels": "按模式选择模型",
  "settings.providers.custom.note": "通过 Base URL 添加 OpenAI 兼容模型API。",
  "settings.providers.modeModels.description": "为特定模式覆盖默认模型。如果未设置，将使用全局默认模型。",
  "provider.custom.title": "自定义模型API",
  "provider.custom.description.prefix": "配置 OpenAI 兼容的模型API。请参阅",
  "provider.custom.description.link": "模型API配置文档",
  "provider.custom.description.suffix": "。",
  "provider.custom.field.providerID.label": "模型API ID",
  "provider.custom.field.providerID.placeholder": "myprovider",
  "provider.custom.field.providerID.description": "小写字母、数字、连字符或下划线",
  "provider.custom.field.name.label": "显示名称",
  "provider.custom.field.name.placeholder": "我的 AI 模型API",
  ...
  "provider.custom.edit.title": "编辑模型API",
  ...
  "provider.custom.error.providerID.required": "模型API ID 为必填项",
  "provider.custom.error.providerID.format": "使用小写字母、数字、连字符或下划线",
  "provider.custom.error.providerID.exists": "该模型API ID 已存在",
  ...
  "settings.agentBehaviour.permissions.title": "工具与权限",
  ...
  "settings.agentBehaviour.workflows.description":
    "工作流是在配置中定义的自定义斜杠命令。在聊天中输入 /command-name 来调用它们。命令在 testagent.json 的 'command' 部分中配置。",
  "settings.agentBehaviour.workflows.empty": "未配置自定义命令。将命令添加到 testagent.json 即可在此处看到。",
  ...
  "settings.autoApprove.level.deny": "禁用",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "从旧版 TestAgent Code 安装迁移设置，包括模型API API 密钥和默认模型。",
  ...
  "migration.select.providers": "模型API API 密钥",
